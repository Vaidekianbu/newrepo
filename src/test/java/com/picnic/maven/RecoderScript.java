...
System.setProperty("webdriver.chrome.driver","C:UsersIP-130\\Selenium Training\\seleniumProjecttraining\\drivers\\chromedriver.exe");
...
public void testParameterWithXML() throws InterruptedException, ATUTestRecorderException{
	ATUTestRecorder recorder = new ATUTestRecorder("C:\\Users\\IP-130\\Videos\\Captures","myvideo",false);
	recorder.start(); 
